...
public class SavingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Chart Related
        lineChart = findViewById(R.id.lineChartSavings);
    ...
    private void viewTransactionHistory()
    {
        ...
        Cursor data = myDB.getListContentSavings();
        ...
        else
        {
            while(data.moveToNext())
            {
                if (data.getString(2).equals("Cheque") ||
                        data.getString(2).equals("Credit") ||
                ...
                else if (data.getString(2).equals("Savings")) {
                    // This value is the column ID for the Items
                    theList.add("\n    " + String.format("R%.2f", data.getDouble(5)) + " WAS HOW MUCH YOU HAD\n" +
    ...
    private void executeShow()
    {
        ...
        lineData.setValueFormatter(new SavingsActivity.myValueFormatter());
    ...
    private void styling()
    {
        ...
        xAxis.setValueFormatter(new SavingsActivity.MyAxisValueFormatter());
        yAxisLeft.setValueFormatter(new SavingsActivity.MyYAxisValueFormatter());
...
//        }
        ...
        Cursor data = myDB.getGraphContentSavings();
