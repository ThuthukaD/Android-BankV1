...
public class BusinessActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Chart Related
        lineChart = findViewById(R.id.lineChartBusiness);
    ...
    private void viewTransactionHistory()
    {
        ...
        Cursor data = myDB.getListContentBusiness();
    ...
    private void executeShow()
    {
        ...
        lineData.setValueFormatter(new BusinessActivity.myValueFormatter());
    ...
    private void styling()
    {
        ...
        xAxis.setValueFormatter(new BusinessActivity.MyAxisValueFormatter());
        yAxisLeft.setValueFormatter(new BusinessActivity.MyYAxisValueFormatter());
...
//        }
        ...
        Cursor data = myDB.getGraphContentBusiness();
